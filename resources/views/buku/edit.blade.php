<x-app-layout>
    ...
    <x-slot name="header">
        <h1 class="text-xl font-semibold text-gray-800">Edit Buku</h1>
    </x-slot>
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-xl border border-gray-200">
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-base font-semibold text-gray-800">Edit Data Buku</h2>
                <p class="text-sm text-gray-500 mt-0.5">Perbarui informasi buku di bawah ini</p>
            </div>

            <form method="POST" action="{{ route('buku.update', $buku) }}" class="p-6 space-y-5" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    >
                    <p class="mt-1 text-xs text-gray-400">Kosongkan jika tidak ingin mengubah cover. Format: JPG, PNG, WEBP. Maks 2MB</p>
